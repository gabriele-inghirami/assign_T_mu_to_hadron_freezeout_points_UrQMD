...
files=("res_elb_1_23_F_plot_data_binary.pickle","res_elb_4_F_plot_data_binary.pickle","res_elb_10_8_F_plot_data_binary.pickle","res_ecm_7_7_F_plot_data_binary.pickle","res_ecm_9_1_F_plot_data_binary.pickle","res_ecm_11_5_F_plot_data_binary.pickle","res_ecm_14_5_F_plot_data_binary.pickle","res_ecm_19_6_F_plot_data_binary.pickle", "res_ecm_27_F_plot_data_binary.pickle","res_ecm_39_F_plot_data_binary.pickle","res_ecm_62_4_F_plot_data_binary.pickle")
...
ax.legend()
fig.savefig("dN_over_NdT.png",dpi=300)
plt.close()
...
ax.grid(b=True, which='major', color='grey', linestyle='-', alpha=0.5)
ax.grid(b=True, which='minor', color='grey', linestyle=':', alpha=0.5)
ax.text(400,0.0255,'Au+Au (UrQMD)\nb$\leq$3.4 fm\n|y|$\leq$0.5\np$_\mathrm{T}\leq$3 GeV') 
...
ax.legend()
fig.savefig("dN_over_Ndmu.png",dpi=300)
plt.close()
