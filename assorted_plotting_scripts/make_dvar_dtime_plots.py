...
ax.legend()
fig.savefig("s_vs_time.png",dpi=300)
plt.close()
...
ax.legend()
fig.savefig("dsdt_vs_time.png",dpi=300)
plt.close()
...
ax.legend()
fig.savefig("nbab_vs_time.png",dpi=300)
plt.close()
...
ax.legend()
fig.savefig("energy_per_particle_vs_time.png",dpi=300)
plt.close()
...
ax.legend()
fig.savefig("sT3_vs_time.png",dpi=300)
plt.close()
